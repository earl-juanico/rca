...
from moondream import MoondreamModel, CustomMoondreamModel
...
class HfMoondream(PreTrainedModel):
    ...
    def __init__(self, config):
        ...
        # Added 06/06/2024 by earl-juanico
        # Use the CustomMoondreamModel to allow RCA
        self.model = CustomMoondreamModel(
