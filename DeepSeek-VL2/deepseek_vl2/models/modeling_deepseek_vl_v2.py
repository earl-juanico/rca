...
class CustomDeepseekVLV2ForCausalLM(DeepseekVLV2ForCausalLM):
    def __init__(self, config, threshold=-0.5):
        super().__init__(config)
        self.threshold = threshold

        # Load your custom LLM
        self.language = CustomDeepseekV2ForCausalLM(config.language_config)

        # Assign the method after it is defined
        self.language.modify_hidden_states = self.modify_hidden_states
...
AutoModelForCausalLM.register(DeepseekVLV2Config, CustomDeepseekVLV2ForCausalLM)
