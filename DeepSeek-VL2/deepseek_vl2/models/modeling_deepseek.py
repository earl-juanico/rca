...
# 2025 04 06
# Modifications were integrated due to bugs
# Reference: https://github.com/deepseek-ai/DeepSeek-VL2/issues/4#issuecomment-2562709343
...
class DeepseekV2ForCausalLM(DeepseekV2PreTrainedModel):
    ...
    def prepare_inputs_for_generation(
        ...
        cache_length = 0 # debug: https://github.com/deepseek-ai/DeepSeek-VL2/issues/4#issuecomment-2562709343
        past_length = 0
        ...
        if inputs_embeds is not None and (past_key_values is None or cache_length == 0): ##### modified here
