...
# There seems to be a promise in this combination for RCA
#   Tested at RCA threshold = -1.0
...
def get_model_processor(model_dir, device='cuda:0'):
    # TODO: remove the trust_remote_code=True when the model is available in the official transformers repo
        ...
        messages = [
            ...
            },
            {
                ...
                "content": [
                    ...
                    #{"type": "text", "text": f'<detect> {question_text}'},
                ],
            }
        ]
